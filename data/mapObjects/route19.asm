Route19Object:
	...
	object SPRITE_SWIMMER_F,          $08, $2b, STAY, LEFT,   $7, OPP_SWIMMER_F,  $c
	object SPRITE_SWIMMER_F,          $0b, $2b, STAY, RIGHT,  $8, OPP_SWIMMER_F,  $d
	object SPRITE_SWIMMER,          $09, $2a, STAY, UP,     $9, OPP_SWIMMER, $8
	object SPRITE_SWIMMER_F,          $0a, $2c, STAY, DOWN,   $a, OPP_SWIMMER_F,  $e
