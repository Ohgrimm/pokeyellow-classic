CinnabarGymObject:
	...
	object SPRITE_BURGLAR, $11, $8, STAY, DOWN, $3, OPP_BURGLAR, $4
	object SPRITE_BLACK_HAIR_BOY_2, $b, $4, STAY, DOWN, $4, OPP_SUPER_NERD, $a
	object SPRITE_BURGLAR, $b, $8, STAY, DOWN, $5, OPP_BURGLAR, $5
	object SPRITE_BLACK_HAIR_BOY_2, $b, $e, STAY, DOWN, $6, OPP_SUPER_NERD, $b
	object SPRITE_BURGLAR, $3, $e, STAY, DOWN, $7, OPP_BURGLAR, $6
