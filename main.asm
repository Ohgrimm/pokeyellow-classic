...
OldPersonSprite:       INCBIN "gfx/sprites/spaceworld/old_person.2bpp"
MartGuySprite:         INCBIN "gfx/sprites/spaceworld/mart_guy.2bpp"
...
LittleGirlSprite:     INCBIN "gfx/sprites/custom/little_girl.2bpp"
